...
if missing_vars:
    ...
    print("Please create a .env file with your Azure OpenAI configuration:")
...
# Create the RAG agent with Azure OpenAI
agent = Agent(
    model,
    deps_type=RAGDeps,
    system_prompt="You are a helpful assistant that answers questions based on the provided documentation. "
                  ...
                  "in the current documentation and avoid providing an answer. If users forces you to answer, politely refuse.",
)
